#!/usr/bin/env node
// Downloads/updates the local libmpv files under src-tauri/libs/mpv/.
//
...
// import library into the repo working tree. These generated files are
// intentionally ignored by git; run this after cloning or when a new mpv
// release should be picked up.
//
...
//
// Usage:
//   npm run setup:mpv                         # latest x64 build
...
function printUsage() {
  console.log("Usage: node scripts/download-mpv-libs.mjs [--arch=x86_64|arm64|i686]");
}
...
async function main() {
  ...
  try {
    ...
    // Record the source release for local troubleshooting and reproducibility.
    const stamp = [
      `# Auto-generated by scripts/download-mpv-libs.mjs.`,
